...
class RawConverter:
    ...
    def ConvertToTSV(self, outfileDirectory, filename):
        rawfile = MSFileReader(
            self.rawfile)
        #print(rawfile.GetMassPrecisionEstimate(1))
        ...
        #val = rawfile.GetControllerType('MS')
        ...
        with open(f'{outfileDirectory}/{filename}.tsv', 'wt') as f:
